...
Remarcação: Interface intuitiva para mover ou editar horários existentes.
...
Vinculação de serviços específicos a cada profissional.
...
Visão Gerencial: Dashboard para acompanhar o desempenho e faturamento da barbearia.
...
Front-end: HTML5, CSS3 e JavaScript / TypeScript.

Back-end:Node.js com TypeScript.

Banco de Dados: PostgreSQL rodando via Docker para persistência de dados.
